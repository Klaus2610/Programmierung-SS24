...
# t1_start
plot(x= airquality$Temp, y=airquality$Ozone,xlab= "Temperatur  [\U{00B0}Fahrenheit]", 
     ylab= "\U00D8 Ozon  [ppb]", pch= 16, las=1,
     col=("#FFA50080"), xlim =c(50,100), 
     main="Mehr Ozon an warmen Tagen", cex=c(airquality$Wind/5))
## t1_ende
...
# t5_start
legend("topleft", title= "Windgeschwindigkeit  [mph]",legend = leg_wind,
       pch= 16, col = "orange", pt.cex=c(2,5,10,20)/5)
# t5_ende
